...
const Form = () => {
  ...
  return (
    ...
    <h1>Register</h1>
    <form>
    <input placeholder="login" type="text" id='login' value={state.login} onChange={handleChange}/>
    <input placeholder="password" id='password' type="password" value={state.password} onChange={handleChange}/>
    <input
      type="submit"
